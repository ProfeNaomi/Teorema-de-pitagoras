    ...
    <div className="space-y-8 pb-10">
      <div className="flex flex-col md:flex-row items-center gap-6">
        <div className="flex-1">
          <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-orange-400 mb-4">
        ...
        <div className="w-16 h-16 bg-red-500/10 rounded-2xl border border-red-500/30 flex items-center justify-center shadow-[0_0_15px_rgba(239,68,68,0.2)]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <motion.div whileHover={{ scale: 1.02 }} className="glass-panel p-6 rounded-2xl border-l-4 border-l-red-500 relative overflow-hidden">
          ...
          <h3 className="text-xl font-bold text-white mb-3 flex items-center gap-2">
            <span className="bg-red-500/20 text-red-400 w-6 h-6 rounded-full flex items-center justify-center text-sm">1</span>
          ...
          <div className="bg-slate-900 p-4 rounded-xl border border-red-500/30">
            ...
            <p className="text-slate-400 text-xs">"Veo un triángulo con lados 5 y 7. ¡Voy a usar Pitágoras para sacar el otro lado!"</p>
        ...
        <motion.div whileHover={{ scale: 1.02 }} className="glass-panel p-6 rounded-2xl border-l-4 border-l-orange-500 relative overflow-hidden">
          ...
          <h3 className="text-xl font-bold text-white mb-3 flex items-center gap-2">
            <span className="bg-orange-500/20 text-orange-400 w-6 h-6 rounded-full flex items-center justify-center text-sm">2</span>
          ...
          <div className="bg-slate-900 p-4 rounded-xl border border-orange-500/30">
            <div className="flex items-center gap-2 text-orange-400 mb-2 font-bold text-sm">
              <XCircle className="w-4 h-4" /> Error en Ecuación:
            </div>
            <div className="text-slate-400 text-sm mb-2"><BlockMath math="x^2 = 3^2 + 5^2 \Rightarrow x = \sqrt{34}" /></div>
            <div className="text-emerald-400 text-xs font-semibold">
              ✔ Solución Correcta: La hipotenusa siempre va sola de un lado de la ecuación. <br/>
              <span className="inline-block mt-1 font-mono bg-emerald-500/10 px-2 py-1 rounded">5² = 3² + x² ➔ 25 - 9 = x² ➔ x = 4</span>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div whileHover={{ scale: 1.02 }} className="glass-panel p-6 rounded-2xl border-l-4 border-l-yellow-500 relative overflow-hidden">
          ...
          <h3 className="text-xl font-bold text-white mb-3 flex items-center gap-2">
            <span className="bg-yellow-500/20 text-yellow-400 w-6 h-6 rounded-full flex items-center justify-center text-sm">3</span>
          ...
          <div className="bg-slate-900 p-4 rounded-xl border border-yellow-500/30">
        ...
        <motion.div whileHover={{ scale: 1.02 }} className="glass-panel p-6 rounded-2xl border-l-4 border-l-pink-500 relative overflow-hidden">
          ...
          <h3 className="text-xl font-bold text-white mb-3 flex items-center gap-2">
            <span className="bg-pink-500/20 text-pink-400 w-6 h-6 rounded-full flex items-center justify-center text-sm">4</span>
          ...
          <div className="bg-slate-900 p-4 rounded-xl border border-pink-500/30">
            <div className="flex items-center gap-2 text-pink-400 mb-2 font-bold text-sm">
              <XCircle className="w-4 h-4" /> Falacia Matemática:
            </div>
            <div className="text-slate-400 text-sm mb-2 text-center text-red-300">
      ...
      <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 p-6 rounded-2xl border border-red-500/20 flex gap-4 items-center mt-4">
        <TriangleAlert className="w-10 h-10 text-orange-400 shrink-0" />
